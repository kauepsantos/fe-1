...
Title.TextSize = 18
Title.Text = "Infinite Yield (error_scripts)" .. currentVersion
...
task.spawn(function()
	...
	minimizeHolder()
	if IsOnMobile then notify("Unstable Device", "este script não esta funcionado muito bem por que esta beta (tubegamer mensagem).") end
end)
